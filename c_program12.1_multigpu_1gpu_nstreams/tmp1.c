...
__global__ void horizontal_diffusion_kernel0(float *tendency) {
	
	printf(".");
}

__global__ void horizontal_diffusion_kernel(int *ids, int *ide, int *jds, int *jde, int *kds,
		int *kde, int *ims, int *ime, int *jms, int *jme, int *kms, int *kme, int *its, int *ite,
		int *jts, int *jte, int *kts, int *kte, int *cf_specified, int *cf_nested, int *cf_open_xs,
		int *cf_open_xe, int *cf_open_ys, int *cf_open_ye, int *cf_periodic_x, int *cf_polar,
		char *name, float *field, float *tendency, float *mu, float *msfux, float *msfuy,
		float *msfvx, float *msfvx_inv, float *msfvy, float *msftx, float *msfty, float *khdif,
		float *xkmhd, float *rdx, float *rdy, int sub_js, int sub_je, int data_js, int data_je) {
	...
	if (*name == 'u') {
		...
		j_start = (((j_start)>(sub_js))?(j_start):(sub_js)); 
		j_end = (((j_end)<(sub_je))?(j_end):(sub_je)); 
