...
TAU_PROFILE_TIMER(tautimer, "void horizontal_diffusion_c_(int *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int *, int *, char *, float *, float *, float *, float *, float *, float *, float *, float *, float *, float *, float *, float *, float *, float *) C [{hdOpenmpFor.c} {7,1}-{340,1}]", " ", TAU_USER);
